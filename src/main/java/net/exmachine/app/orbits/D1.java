 ...
 */
public class D1 extends OrbitSpace {
  private final double triangleCoefficient;

  /**
   * Creates a Southworth &amp; Hawkins criterion space for the given orbits and maximal value
   * of an eccentricity {@code E}.
   *
   * @param elements the orbits, one row per element
   * @param E        maximal expected eccentricity, used to derive the relaxed triangle
   *                 inequality constant
   */
  public D1(double[][] elements, double E) {
    super(elements);
