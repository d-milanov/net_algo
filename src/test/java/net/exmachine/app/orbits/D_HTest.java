...
class D_HTest {
  ...
  void distanceIsZeroForIdenticalOrbits() {
    D_H space = new D_H(sampleOrbits(), E_MAX);
  ...
  void distanceIsSymmetric() {
    ...
    D_H space = new D_H(elements, E_MAX);
  ...
  @Test
  void triangleCoefficientMatchesRelaxedTriangleInequalityFormula() {
    D_H space = new D_H(sampleOrbits(), E_MAX);

    assertEquals(Math.sqrt(2 + 4 * E_MAX * E_MAX), space.getTriangleCoefficient(), 1e-12);
  }
